...
## Demo Apps
- Streamlit: `make app` -> localhost:8501 (5 pages)
- Page 1: Patient Assessment | Page 2: PBW Comparison | Page 3: Portfolio Dashboard | Page 4: Alzheimer Progression | Page 5: KTG Kalkulation
