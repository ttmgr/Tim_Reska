...
class DocPDF(FPDF):
    ...
    def footer(self):
        ...
        self.cell(0, 5, f"Page {self.page_no()} | the author | March 2026", align="C")
    ...
    def cover(self, title, subtitle):
        ...
        self.cell(0, 5, "the author | Helmholtz Munich | March 2026", align="C", new_x="LMARGIN", new_y="NEXT")
...
def make_what_we_built():
    ...
    pdf.p("231 unit tests, all passing. Lint clean (ruff). 5 Jupyter notebooks execute without error.")
...
def make_data_requirements():
    ...
    pdf.li("4. a major European insurer Internal -- target. Requires partnership + DPO.")

    pdf.h2("Legal Basis")
    pdf.li("Germany: SGB X Section 75 + DSGVO Art. 89")
    pdf.li("UK: UK GDPR + NHS Act 2006 Section 251")
    pdf.li("a major European insurer: DSGVO Art. 6(1)(f) + Art. 35 DPIA")
