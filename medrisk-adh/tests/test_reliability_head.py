...
class TestReliabilityHead:
    ...
    def test_cost_affects_decisions(self):
        ...
        head_strict = ReliabilityHead(
            ReliabilityConfig(cost_fn=20.0, cost_fp=1.0, cost_review=0.5)
        )
        ...
        head_lenient = ReliabilityHead(
            ReliabilityConfig(cost_fn=0.1, cost_fp=1.0, cost_review=0.5)
        )
